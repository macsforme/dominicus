...
void ShellRenderer::execute(std::map<std::string, void*> arguments) {
	...
	glVertexAttribPointer(attributes["position"], 3, GL_FLOAT, GL_FALSE, 10 * sizeof(GL_FLOAT), (GLvoid*) 0);
	glVertexAttribPointer(attributes["normal"], 3, GL_FLOAT, GL_FALSE, 10 * sizeof(GL_FLOAT), (GLvoid*) (3 * sizeof(GLfloat)));
	glVertexAttribPointer(attributes["color"], 4, GL_FLOAT, GL_FALSE, 10 * sizeof(GL_FLOAT), (GLvoid*) (6 * sizeof(GLfloat)));
