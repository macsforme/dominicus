...
*/
	...
	*((Vector2*) gameLogic->gaugePanelEntry.second["progressBarSize"]) = Vector2(gameSystem->getFloat("hudGaugeWidth"), gameSystem->getFloat("hudGaugeHeight"));
	...
	(*((std::vector<float>*) gameLogic->gaugePanelEntry.second["progressions"]))[2] = (gameState->fortress.shock < 0.0f ? -gameState->fortress.shock : gameState->fortress.shock);
	...
	*((Vector4*) gameLogic->gaugePanelEntry.second["backgroundColorBottom"]) = Vector4(
	...
	(*((std::vector<Vector4>*) gameLogic->gaugePanelEntry.second["progressBarColorsTop"]))[2] = gameSystem->getColor(gameState->fortress.shock < 1.0f && gameState->fortress.shock > 0.0f ? "hudGaugeShockChargingBarColor" : "hudGaugeShockChargedBarColor");
	...
	(*((std::vector<Vector4>*) gameLogic->gaugePanelEntry.second["progressBarColorsBottom"]))[2] = Vector4(
			gameSystem->getColor(gameState->fortress.shock < 1.0f && gameState->fortress.shock > 0.0f ? "hudGaugeShockChargingBarColor" : "hudGaugeShockChargedBarColor").x * gameSystem->getColor("hudGaugeColorFalloff").x,
			gameSystem->getColor(gameState->fortress.shock < 1.0f && gameState->fortress.shock > 0.0f ? "hudGaugeShockChargingBarColor" : "hudGaugeShockChargedBarColor").y * gameSystem->getColor("hudGaugeColorFalloff").y,
			gameSystem->getColor(gameState->fortress.shock < 1.0f && gameState->fortress.shock > 0.0f ? "hudGaugeShockChargingBarColor" : "hudGaugeShockChargedBarColor").z * gameSystem->getColor("hudGaugeColorFalloff").z,
			gameSystem->getColor(gameState->fortress.shock < 1.0f && gameState->fortress.shock > 0.0f ? "hudGaugeShockChargingBarColor" : "hudGaugeShockChargedBarColor").w * gameSystem->getColor("hudGaugeColorFalloff").w
		);
